...
// initializes the member m_with n and initializes the vector m_grid
...
// definition of method side. Returns the value of private member m_side
// useful for some calculation in other methods, free function
// and functions defined in file main_graph.cpp
...
world successive_stage(world const &present, double beta_, double gamma_) {
  ...
  for (int i = 0; i != n; ++i) {
    for (int j = 0; j != n; ++j) {
      ...
      // value of infected day by day in this code it translates into a "+1" in
      // to the number of neighbours infected a susceptible person has near
